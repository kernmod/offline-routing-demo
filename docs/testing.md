...
| P6d signed ad hoc build | [`docs/evidence/2026-09-01T08-44-36Z-ios-eas-signed-build.md`](evidence/2026-09-01T08-44-36Z-ios-eas-signed-build.md) | EAS `INTERNAL` arm64 archive finished; bundle, assets, signing profile count, integrity and checksum inspected | green |
