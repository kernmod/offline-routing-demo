...
| P6a Android elevation-cut device smoke | [`docs/evidence/2026-09-01T09-44-51Z-elevation-cut-android.md`](evidence/2026-09-01T09-44-51Z-elevation-cut-android.md) | release APK on `redroid14_x86_64` / Android 14 in airplane mode; direct handle drag changed start from 0 m to 87 m with a 44 dp target | green |
...
| P6d signed ad hoc build | [`docs/evidence/2026-09-01T08-44-36Z-ios-eas-signed-build.md`](docs/evidence/2026-09-01T08-44-36Z-ios-eas-signed-build.md) | EAS `INTERNAL` arm64 archive finished; bundle, assets, signing profile count, integrity and checksum inspected | green |
